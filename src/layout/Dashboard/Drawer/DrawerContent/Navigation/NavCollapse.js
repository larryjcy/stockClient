...
const NavCollapse = ({ menu, level, parentId, setSelectedItems, selectedItems, setSelectedLevel, selectedLevel, sessionUser, memberAcls }) => {
  const theme = useTheme()
  const {getDrawerOpen, updateActiveMenuId} = useUserContext()
